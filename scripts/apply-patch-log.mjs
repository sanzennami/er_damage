...
const PRESENTATION_FIELDS = ['slot', 'levelSlot', 'maxStacks', 'stackLabel', 'stackStep', 'defaultStacks', 'form', 'maxHits', 'defaultHits', 'hitLabel', 'hitNote', 'kind', 'buffKey', 'damageType', 'progressiveDamage', 'selfAmp'];
